...
def getHerokuDetails(h_api_key, h_app_name):
    ...
    try:
        ...
        if EMOJI_THEME is True:
            ...
            abc += f'<b>❖ 🄷🄴🅁🄾🄺🅄 🅂🅃🄰🅃🅂 ❖</b>\n'
            abc += f'<b></b>\n'
            abc += f"<b>❖ 𝗙𝗨𝗟𝗟</b>: {get_readable_time(account_quota)}\n"
            abc += f"<b>❖ 𝗨𝗦𝗘𝗗</b>: {get_readable_time(quota_used)}\n"
            abc += f"<b>❖ 𝗙𝗥𝗘𝗘</b>: {get_readable_time(quota_remain)}\n"
        # App Quota
        AppQuotaUsed = 0
        OtherAppsUsage = 0
        ...
        if EMOJI_THEME is True:
            ...
            abc += f"<b>❖ 𝗔𝗣𝗣 𝗨𝗦𝗔𝗚𝗘:</b> {get_readable_time(AppQuotaUsed)}\n"
            abc += f"<b>❖ 𝗢𝗧𝗛𝗘𝗥 𝗔𝗣𝗣:</b> {get_readable_time(OtherAppsUsage)}\n"
            abc += f'<b></b>\n'
...
IMAGE_X = "https://telegra.ph/file/5793f76d2f83ccb69991c.jpg"
...
def stats(update, context):
    if ospath.exists('.git'):
        if EMOJI_THEME is True:
            ...
            last_commit = check_output(["git log -1 --date=short --pretty=format:'%cd \n<b>❖</b> <b>𝗙𝗿𝗼𝗺</b> %cr'"], shell=True).decode()
    else:
    ...
    if EMOJI_THEME is True:
            ...
            stats = f'<b>❖ 🄱🄾🅃 🅂🅃🄰🅃🄸🅂🅃🄸🄲🅂 ❖</b>\n' \
                    f'<b> </b>\n' \
                    f'<b>❖  𝗖𝗢𝗠𝗠𝗜𝗧 𝗗𝗔𝗧𝗘:</b> {last_commit}\n'\
                    f'<b>❖  𝗢𝗡𝗟𝗜𝗡𝗘 𝗧𝗜𝗠𝗘:</b> {currentTime}\n'\
                    f'<b>❖  𝗦𝗧𝗔𝗥𝗧𝗘𝗗 𝗔𝗧:</b> {current}\n'\
                    f'<b>❖  𝗢𝗦 𝗨𝗣𝗧𝗜𝗠𝗘:</b> {osUptime}\n'\
                    f'<b>❖  𝗗𝗜𝗦𝗞 𝗦𝗣𝗔𝗖𝗘:</b> {total}\n'\
                    f'<b>❖  𝗗𝗜𝗦𝗞 𝗦𝗣𝗔𝗖𝗘 𝗨𝗦𝗘𝗗:</b> {used}\n'\
                    f'<b>❖  𝗗𝗜𝗦𝗞 𝗦𝗣𝗔𝗖𝗘 𝗙𝗥𝗘𝗘:</b> {free}\n'\
                    f'<b>❖  𝗨𝗣𝗟𝗢𝗔𝗗 𝗗𝗔𝗧𝗔:</b> {sent}\n'\
                    f'<b>❖  𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 𝗗𝗔𝗧𝗔:</b> {recv}\n'\
                    f'<b>❖  𝗖𝗣𝗨 𝗨𝗦𝗔𝗚𝗘:</b> {cpuUsage}%\n'\
                    f'<b>❖  𝗥𝗔𝗠:</b> {mem_p}%\n'\
                    f'<b>❖  𝗗𝗜𝗦𝗞 𝗨𝗦𝗘𝗗:</b> {disk}%\n'\
                    f'<b>❖  𝗣𝗛𝗬𝗦𝗜𝗖𝗔𝗟 𝗖𝗢𝗥𝗘𝗦:</b> {p_core}\n'\
                    f'<b>❖  𝗧𝗢𝗧𝗔𝗟 𝗖𝗢𝗥𝗘𝗦:</b> {t_core}\n'\
                    f'<b>❖  𝗦𝗪𝗔𝗣:</b> {swap_t}\n'\
                    f'<b>❖  𝗦𝗪𝗔𝗣 𝗨𝗦𝗘𝗗:</b> {swap_p}%\n'\
                    f'<b>❖  𝗧𝗢𝗧𝗔𝗟 𝗢𝗙 𝗠𝗘𝗠𝗢𝗥𝗬:</b> {mem_t}\n'\
                    f'<b>❖  𝗙𝗥𝗘𝗘 𝗢𝗙 𝗠𝗘𝗠𝗢𝗥𝗬:</b> {mem_a}\n'\
                    f'<b>❖  𝗨𝗦𝗔𝗚𝗘 𝗢𝗙 𝗠𝗘𝗠𝗢𝗥𝗬:</b> {mem_u}\n'
...
def restart(update, context):
    ...
    if dynoRestart:
        ...
        LOGGER.info("Killing Dyno. Pea Masamba")
...
def main():
    ...
    if ospath.isfile(".restartmsg"):
        ...
        for id_ in AUTHORIZED_CHATS:
            try:
                bot.sendMessage(id_, "𝐁𝐨𝐭 𝐂𝐌𝐓 𝐑𝐞𝐬𝐭𝐚𝐫𝐭𝐞𝐝❗", 'HTML')
            except Exception as e:
                LOGGER.error(e)
