...
try:
    ...
    START_BTN1_URL = 'https://t.me/RequestMovie84'
...
try:
    ...
    START_BTN2_URL = 'https://t.me/Collection_MovieTerbaik'
...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @Collection_MovieTerbaik")
    CHANNEL_USERNAME = "Collection_MovieTerbaik"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @Collection_MovieTerbaik")
    FSUB_CHANNEL_ID = -1001447404131
try:
...
try:
    ...
    IMAGE_URL = 'https://telegra.ph/file/5793f76d2f83ccb69991c.jpg'
try:
