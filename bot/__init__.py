...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @RequestMovie84")
    CHANNEL_USERNAME = "RequestMovie84"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @RequestMovie84")
